...
if ( ! function_exists( 'bfi_wp_image_editor_check_notice' ) ) {
    function bfi_wp_image_editor_check_notice() {
        ...
        esc_html__( 'The server does not have ImageMagick or GD installed and/or enabled! Any of these libraries are required for WordPress to be able to resize images. Please contact your server administrator to enable this before continuing.', 'unilearn' ));
    }
}
...
if ( ! class_exists( 'BFI_Image_Editor_GD_1_2' ) ) {
    ...
    class BFI_Image_Editor_GD_1_2 extends WP_Image_Editor_GD {
        ...
        public function rotate( $angle ) {
            ...
            return new WP_Error( 'image_rotate_error', esc_html__( 'Image rotate failed.', 'unilearn' ), $this->file );
        }
        ...
        public function opacity( $opacity ) {
            ...
            return new WP_Error( 'image_opacity_error', esc_html__( 'Image opacity change failed.', 'unilearn' ), $this->file );
        }
        ...
        public function colorize( $hexColor ) {
            ...
            return new WP_Error( 'image_colorize_error', esc_html__( 'Image color change failed.', 'unilearn' ), $this->file );
        }
        ...
        public function grayscale() {
            ...
            return new WP_Error( 'image_grayscale_error', esc_html__( 'Image grayscale failed.', 'unilearn' ), $this->file );
        }
        ...
        public function negate() {
            ...
            return new WP_Error( 'image_negate_error', esc_html__( 'Image negate failed.', 'unilearn'  ), $this->file );
        }
    }
}
...
if ( ! class_exists( 'BFI_Thumb_1_2' ) ) {
    ...
    class BFI_Thumb_1_2 {
        ...
        public static function thumb( $url, $params = array(), $single = true ) {
            ...
            if ( ( isset( $retina_width ) && $retina_width === 0 ) && ( isset( $retina_height ) && $retina_height === 0 ) ){
                $retina_thumb = false;
            }
